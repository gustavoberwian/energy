...
class Painel extends Painel_Controller {
	...
	public function index()
	{
        ...
        $data['mes']      = number_format(round($consumo->value), 0, ",", ".")." <span style='font-size:10px;'>L</span>";
        $data['previsao'] = number_format(round($consumo->value / ceil(abs(time() - strtotime(date("Y-m-01"))) / 86400) * date("t")), 0, ",", ".")." <span style='font-size:10px;'>L</span>";
