...
$config['tables']['login_attempts']  = 'auth_attempts';
 ...
 */
$config['site_title']                 = "Easymeter";       // Site Title, example.com
$config['admin_email']                = "contato@easymeter.com.br"; // Admin Email, admin@example.com
$config['default_group']              = 'unidades';           // Default group, use name
...
$config['email_config'] = array(
    ...
    'smtp_port'    => '587',
    'smtp_timeout' => '60',
    'smtp_user'    => 'contato@easymeter.com.br',
    'smtp_pass'    => 'index#1996',
    'charset'      => 'utf-8',
    'newline'      => "\r\n",
    'mailtype'     => "html",
    'smtp_crypto'  => 'tls'
...
$config['message_start_delimiter'] = '<li><label>'; 	// Message start delimiter
$config['message_end_delimiter']   = '</label></li>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<li><label>';	    // Error mesage start delimiter
$config['error_end_delimiter']     = '</label></li>';   // Error mesage end delimiter
